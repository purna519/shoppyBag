...
export default function Home(){
  ...
  const categories = [
    { name: 'Men Clothing', icon: 'bi-person', gradient: 'linear-gradient(135deg, #b8985f 0%, #8b6f47 100%)' },
    { name: 'Women Clothing', icon: 'bi-gender-female', gradient: 'linear-gradient(135deg, #a0826d 0%, #6d564b 100%)' },
    { name: 'Footwear', icon: 'bi-shop', gradient: 'linear-gradient(135deg, #9c7c5f 0%, #6b5545 100%)' },
    { name: 'Watches', icon: 'bi-watch', gradient: 'linear-gradient(135deg, #b89968 0%, #87703e 100%)' },
    { name: 'Jewelry', icon: 'bi-gem', gradient: 'linear-gradient(135deg, #c9a86a 0%, #a17c48 100%)' },
    { name: 'Bags', icon: 'bi-handbag', gradient: 'linear-gradient(135deg, #8d6e53 0%, #5d4a3f 100%)' },
    { name: 'Cosmetics', icon: 'bi-stars', gradient: 'linear-gradient(135deg, #d4b896 0%, #a28968 100%)' },
    { name: 'Accessories', icon: 'bi-sunglasses', gradient: 'linear-gradient(135deg, #bfa580 0%, #8c7456 100%)' }
  ]
